...
int PQCLEAN_FRODOKEM640SHAKE_CLEAN_crypto_kem_keypair(uint8_t *pk, uint8_t *sk, uint8_t *randomness) {
...
int PQCLEAN_FRODOKEM640SHAKE_CLEAN_crypto_kem_enc(uint8_t *ct, uint8_t *ss, const uint8_t *pk, uint8_t *randomness) {
    ...
    uint8_t *pkh = &G2in[0];
    uint8_t *mu = &randomness[0];                             // contains secret data
